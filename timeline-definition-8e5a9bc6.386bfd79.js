import { w as kt, x as vt, y as wt, e as rt, l as I, s as q, f as St, z as Et, A as Tt, B as et } from "./MystEditor.5bab6932.js";
import { i as It } from "./is_dark.1f7c314d.js";
var X = function() {
  var n = function(k, r, a, h) {
    for (a = a || {}, h = k.length; h--; a[k[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], p = [1, 18], g = [1, 19], d = [1, 23], f = [1, 24], v = [1, 27], _ = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], b = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(r, a, h, u, y, c, M) {
      var x = c.length - 1;
      switch (y) {
        case 1:
          return c[x - 1];
    ...
    table: [{ 3: 1, 4: t, 7: 3, 12: 4, 28: e }, { 1: [3] }, n(s, [2, 3], { 5: 6 }), { 3: 7, 4: t, 7: 3, 12: 4, 28: e }, { 13: 8, 29: [1, 9] }, { 29: [2, 21] }, { 6: [1, 10], 7: 22, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: o, 20: l, 22: p, 23: g, 24: 20, 25: 21, 26: d, 27: f, 28: e }, { 1: [2, 2] }, { 14: 25, 15: [1, 26], 31: v }, n([15, 31], [2, 22]), n(s, [2, 8], { 1: [2, 1] }), n(s, [2, 4]), { 7: 22, 10: 28, 12: 4, 17: i, 18: o, 20: l, 22: p, 23: g, 24: 20, 25: 21, 26: d, 27: f, 28: e }, n(s, [2, 6]), n(s, [2, 7]), n(s, [2, 11]), { 19: [1, 29] }, { 21: [1, 30] }, n(s, [2, 14]), n(s, [2, 15]), n(s, [2, 16]), n(s, [2, 17]), n(s, [2, 18]), n(s, [2, 19]), n(s, [2, 20]), { 11: [1, 31] }, { 16: 32, 30: [1, 33] }, { 11: [2, 24] }, n(s, [2, 5]), n(s, [2, 12]), n(s, [2, 13]), n(_, [2, 9]), { 14: 34, 31: v }, { 31: [2, 23] }, { 11: [1, 35] }, n(_, [2, 10])],
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[T] || T) + "'" : Q = "Parse error on line " + (N + 1) + ": Unexpected " + (T == z ? "end of input" : "'" + (this.terminals_[T] || T) + "'"), this.parseError(Q, {
        ...
        switch ($[0]) {
          case 1:
            ...
            break;
          case 2:
            if (A = this.productions_[$[1]][1], W.$ = y[y.length - A], W._$ = {
              ...
              return K;
            A && (h = h.slice(0, -1 * A * 2), y = y.slice(0, -1 * A), c = c.slice(0, -1 * A)), h.push(this.productions_[$[1]][0]), y.push(W.$), c.push(W._$), tt = M[h[h.length - 2]][h[h.length - 1]], h.push(tt);
            break;
          case 3:
            return !0;
        }
...
const zt = function(n, t, e) {
  ...
  function n(i, o, l, p, g, d, f, v) {
    const _ = o.append("text").attr("x", l + g / 2).attr("y", p + d / 2 + 5).style("font-color", v).style("text-anchor", "middle").text(i);
    s(_, f);
  }
  function t(i, o, l, p, g, d, f, v, _) {
    const { taskFontSize: b, taskFontFamily: w } = v, E = i.split(/<br\s*\/?>/gi);
    for (let k = 0; k < E.length; k++) {
      const r = k * b - b * (E.length - 1) / 2, a = o.append("text").attr("x", l + g / 2).attr("y", p).attr("fill", _).style("text-anchor", "middle").style("font-size", b).style("font-family", w);
      a.append("tspan").attr("x", l + g / 2).attr("dy", r).text(E[k]), a.attr("y", p + d / 2).attr("dominant-baseline", "central").attr("alignment-baseline", "central"), s(a, f);
    }
  }
  function e(i, o, l, p, g, d, f, v) {
    const _ = o.append("switch"), w = _.append("foreignObject").attr("x", l).attr("y", p).attr("width", g).attr("height", d).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    w.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, _, l, p, g, d, f, v), s(w, f);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
`), I.debug("timeline", s.db);
  ...
  _.forEach(function(N) {
    const S = {
      ...
      padding: 20,
      maxHeight: b
    }, L = R.getVirtualNodeHeight(d, S, i);
    I.debug("sectionHeight before draw", L), b = Math.max(b, L + 20);
  });
  let y = 0, c = 0;
  I.debug("tasks.length", f.length);
  ...
  I.debug("maxSectionHeight before draw", b), I.debug("maxTaskHeight before draw", w), _ && _.length > 0 ? _.forEach((N) => {
    const S = {
      number: h,
      descr: N,
      section: h,
  ...
  I.debug("bounds", M), v && d.append("text").text(v).attr("x", M.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), E = u ? b + w + 150 : w + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", E).attr("x2", M.width + 3 * o).attr("y2", E).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), St(
    void 0,
    d,
    i.timeline.padding ? i.timeline.padding : 50,
    i.timeline.useMaxWidth ? i.timeline.useMaxWidth : !1
  );
}, st = function(n, t, e, s, i, o, l, p, g, d, f) {
  for (const v of t) {
    const _ = {
      descr: v.task,
      section: e,
